...
const { getFirestore, collection, addDoc, query,getDoc,doc,getDocs} = require("firebase/firestore/lite");
...
module.exports = { firebase, auth,db,collection,addDoc,query,getDoc,doc,getDocs};